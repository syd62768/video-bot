    ...
    try:
        with YoutubeDL(ydl_opts) as ydl:
            ...
            if result.get("ok"):
                ...
                edit_telegram_message(f"❌ خطا در آپلود تلگرام (ممکن است فرمت فایل مشکل داشته باشد).")

    except Exception as e:
        error_msg = str(e)
        if "filesize" in error_msg.lower():
            edit_telegram_message("❌ <b>خطا:</b> حجم این ویدیو بیشتر از حد مجاز تلگرام (۵۰ مگابایت) است.")
        else:
